...
INSERT INTO Phong(MaPhong, TenPhong, TrangThai, ChiNhanh, TieuChiGioiTinh, HinhAnh, MaLoai) VALUES (101, 'Studio Cao Cấp - T12', 1, 'Quận 1, TP. HCM', 'Nam/Nữ', 'http://localhost:3001/room_images/P101.jpg', 4) 
...
INSERT INTO Phong(MaPhong, TenPhong, TrangThai, ChiNhanh, TieuChiGioiTinh, HinhAnh, MaLoai) VALUES (102, 'Căn Hộ Deluxe - B04', 1, 'Quận 3, TP. HCM', 'Nam/Nữ', 'http://localhost:3001/room_images/P102.jpg', 2) 
ON CONFLICT (MaPhong) DO UPDATE SET TenPhong = EXCLUDED.TenPhong, ChiNhanh = EXCLUDED.ChiNhanh, TieuChiGioiTinh = EXCLUDED.TieuChiGioiTinh, HinhAnh = EXCLUDED.HinhAnh;

INSERT INTO Phong(MaPhong, TenPhong, TrangThai, ChiNhanh, TieuChiGioiTinh, HinhAnh, MaLoai) VALUES (103, 'Phòng Suite View Sông', 1, 'Bình Thạnh, TP. HCM', 'Nam/Nữ', 'http://localhost:3001/room_images/P103.jpg', 3) 
ON CONFLICT (MaPhong) DO UPDATE SET TenPhong = EXCLUDED.TenPhong, ChiNhanh = EXCLUDED.ChiNhanh, TieuChiGioiTinh = EXCLUDED.TieuChiGioiTinh, HinhAnh = EXCLUDED.HinhAnh;

INSERT INTO Phong(MaPhong, TenPhong, TrangThai, ChiNhanh, TieuChiGioiTinh, HinhAnh, MaLoai) VALUES (104, 'Căn Hộ Duplex - Tầng Thượng', 1, 'Quận 2, TP. HCM', 'Nam/Nữ', 'http://localhost:3001/room_images/P104.jpg', 1) 
ON CONFLICT (MaPhong) DO UPDATE SET TenPhong = EXCLUDED.TenPhong, ChiNhanh = EXCLUDED.ChiNhanh, TieuChiGioiTinh = EXCLUDED.TieuChiGioiTinh, HinhAnh = EXCLUDED.HinhAnh;
